        ...
        <>
            <div className="widget basis-full md:basis-[49.3%]">
                <div className="font-bold p-5 py-3 flex justify-between items-center">
                    ...
                    <Link href="/admin/member" className="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm p-5 py-2.5">회원 전체</Link>
                </div>
                        ...
                        userData && userData.map((e,i)=>{
                            ...
                            return(
                                <ul key={i} className="flex justify-between border-b last:border-0 items-center">
                                    <li className="basis-[23%] text-[#6f809a] font-bold text-center text-xs sm:text-sm py-2.5">{e.id}</li>
                                    ...
                                    <li className="basis-1/5 text-[#6f809a] font-bold text-center text-xs sm:text-sm py-2.5">{formatDate}</li>
                                </ul>
                            )
                        })
                    }
